...
export async function analyzeDocument(
  ...
  try {
    ...
    const raw = await requestStructuredAnalysis(
      'scan',
      buildSystemPrompt(docType, 'full', profile),
    ...
    return {
      ...
      requestPhrases: parsed.requestPhrases,
      officialChannels: parsed.officialChannels,
      needsExpertReview: parsed.needsExpertReview,
